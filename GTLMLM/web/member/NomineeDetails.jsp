...
<%
    ...
    try {
        ...
        String query = "SELECT k.bank_info_file, k.pan_card_file, k.aadhar_front_file, k.aadhar_back_file, k.upload_date " +
                       "FROM users u LEFT JOIN nominee_kyc_details k ON u.id = k.user_id WHERE u.id = ?";
        ...
        if (rs.next()) {
            bankInfo = rs.getString("bank_info_file") != null ? rs.getString("bank_info_file") : "";
            panCard = rs.getString("pan_card_file") != null ? rs.getString("pan_card_file") : "";
            aadharFront = rs.getString("aadhar_front_file") != null ? rs.getString("aadhar_front_file") : "";
            aadharBack = rs.getString("aadhar_back_file") != null ? rs.getString("aadhar_back_file") : "";
                    ...
                    <div class="container content-center">
                        ...
                        <div class="container">
                            <div class="card-header">
                                <h2>Upload Nominee KYC</h2>
                                <p class="info-text">Upload your nominee's KYC documents. Allowed formats: .gif, .jpg, .jpeg, .png (Max size: 300 KB).</p>
                                <form action="NomineeKYCDetailsServlet" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container content-center">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <% if (!bankInfo.isEmpty() || !panCard.isEmpty() || !aadharFront.isEmpty() || !aadharBack.isEmpty()) { %>
                                    <tr>
                                        <td><img src="./uploads/kyc/<%= id %>/<%= bankInfo %>" width="100"></td>
                                        <td><img src="./uploads/kyc/<%= id %>/<%= panCard %>" width="100"></td>
                                        <td><img src="./uploads/kyc/<%= id %>/<%= aadharFront %>" width="100"></td>
                                        <td><img src="./uploads/kyc/<%= id %>/<%= aadharBack %>" width="100"></td>
                                        <td><%= uploadDate %></td>
                                    </tr>
                                    <% } else { %>
                                    <tr>
