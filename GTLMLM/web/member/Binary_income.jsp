...
<div class="header">
  <div class="row d-flex flex-wrap align-items-center justify-content-between">
    <div class="col-md-6 col-12 d-flex justify-content-start">
      <!--<span class="title text-truncate">Refer Income</span>-->
    </div>
    <div class="col-md-6 col-12 d-flex justify-content-md-end justify-content-start overflow-hidden">
      <div class="breadcrumb text-nowrap text-truncate ">
        <!--<a href="./account.php" class="breadcrumb-link text-capitalize ">ACCOUNT&nbsp;</a> / <span class="text-uppercase">&nbsp;Refer Income</span>-->
      </div>
    </div>
  </div>
</div>
 ...
 <div class="container content-center" style="margin-top:40px;">
  <h3 class="">Refer Income Details</h3>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row['name'] . "</td>";
                        echo "<td>" . $row['ReferIncome'] . "</td>";
                        
                        $totalIncome = $row['ReferIncome'] ; 
