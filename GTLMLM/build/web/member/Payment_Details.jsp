...
<!--<hr>-->
    ...
    <div class="form-container" style="margin-top:20px; margin-bottom:50px;">
    ...
    <form>
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                value="<?php echo $row['user_id'];?>" id="user_id" name="user_id"
        ...
        <div class="row mb-3">
            <div class="col-md-6">
               ...
               <input type="text" class="form-control unicase-form-control text-input"
                value="<?php echo $row['memberpayed'];?>" id="memberpayed" name="memberpayed"
                 required="required" readonly>
            </div>
            <div class="col-md-6">
                ...
                <input type="date"
                                                            ...
                                                            value="<?php echo $row['dob'];?>" id="dob" name="dob"
                                                            required="required" readonly>
            </div>
        </div>
        <!--<div class="row align-items-end mb-3">-->
        <!--    <div class="col-md-3">-->
        <!--        <label class="label-text">Withdrawal Amount:</label>-->
        <!--        <input type="number" class="form-control" id="withdrawalAmount" value="100" min="0" placeholder="Enter amount">-->
        <!--    </div>-->
        <!--    <div class="col-auto">-->
        <!--        <span class="label-text">X</span>-->
        <!--    </div>-->
        <!--    <div class="col-md-2">-->
        <!--        <input type="number" class="form-control" id="multiplier" value="0" min="0" placeholder="Enter multiplier">-->
        <!--    </div>-->
        <!--    <div class="col-auto">-->
        <!--        <span class="label-text">=</span>-->
        <!--    </div>-->
        <!--    <div class="col-md-2">-->
        <!--        <input type="text" class="form-control" id="calculatedAmount" value="0" readonly>-->
        <!--    </div>-->
        <!--</div>-->
        <div class="row mb-3">
            <div class="col-md-6">
                <label class="label-text">Remain Balance:</label>
                <input type="text" class="form-control" id="afterBalance" value="0" readonly>
            </div>
        </div>
    </form>
