...
<div class="header">
  <div class="row d-flex flex-wrap align-items-center justify-content-between">
    <div class="col-md-6 col-12 d-flex justify-content-start">
      <!--<span class="title text-truncate">My Direct Member</span>-->
    </div>
    <div class="col-md-6 col-12 d-flex justify-content-md-end justify-content-start overflow-hidden">
      <div class="breadcrumb text-nowrap text-truncate ">
        <!--<a href="./account.php" class="breadcrumb-link text-capitalize ">ACCOUNT&nbsp;</a> / <span class="text-uppercase">&nbsp;My Direct Member</span>-->
      </div>
    </div>
  </div>
</div>
...
<br>
 ...
 <div class="container">
  <h3 class="">Total My Direct Members:</h3>
  <div class="table-responsive">
...
if (!empty($leftMembers)) {
    ...
    foreach ($leftMembers as $member) {
        ...
        echo '<td>' . htmlspecialchars($member['contact']) . '</td>';
