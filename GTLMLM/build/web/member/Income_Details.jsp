...
if ($stmt1) {
    ...
    if ($result1->num_rows > 0) {
        ...
        // echo "Fetched user_id: " . $user_id;
        $userId=$user_id;
    } else {
        echo "No user_id found for the provided id: " . $userId;
    }
...
<div class="header">
  <div class="row d-flex flex-wrap align-items-center justify-content-between">
    <div class="col-md-6 col-12 d-flex justify-content-start">
      <!--<span class="title text-truncate">Income Detail</span>-->
    </div>
    <div class="col-md-6 col-12 d-flex justify-content-md-end justify-content-start overflow-hidden">
      <div class="breadcrumb text-nowrap text-truncate ">
        <!--<a href="./account.php" class="breadcrumb-link text-capitalize ">ACCOUNT&nbsp;</a> / <span class="text-uppercase">&nbsp;Income Detail</span>-->
      </div>
    </div>
  </div>
</div>
 ...
 <div class="container content-center" style="margin-top:40px;">
  <h3 class="">Current Income Details</h3>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row1 = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row1['ReferIncome'] . "</td>";
                        echo "<td>" . $row1['ActiveIncome'] . "</td>";
                        echo "<td>" . $row1['MonthlyIncome'] . "</td>";
                        echo "<td>" . $row1['AwardIncome'] . "</td>";
                        echo "<td>" . $row1['TourIncome'] . "</td>";
                        echo "<td>" . $row1['LevelIncome'] . "</td>";
                        echo "<td>" . $row1['NonworkingIncome'] . "</td>";
                      
                        $totalIncome = $row1['ReferIncome'] + $row1['ActiveIncome'] + $row1['MonthlyIncome'] + 
                        $row1['AwardIncome'] + $row1['TourIncome'] + $row1['LevelIncome'] + 
                        $row1['NonworkingIncome'];
